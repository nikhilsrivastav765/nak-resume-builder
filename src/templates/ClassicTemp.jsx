  ...
  return (
      <div className="flex pt-32 pb-32">
       ...
       <div className="w-full">
        ...
        <div className="flex">
      <header className="bg-gray-800 text-white flex flex-col min-h-screen gap-5 w-1/3">
      <div className=" flex items-center justify-center min-h-[20%] w-full">
       ...
       <h2 className="text-xl font-semibold border-b-[2px] pb-1 tracking-wider border-gray-400">CONTACT</h2>
        <h3 className=" flex  gap-2 pl-1 py-1 text-sm pt-5"><FaLocationDot className="pt-1"/>{resumeData.location || "Your Location"}</h3>
        ...
        {resumeData.experience.map((exp, index) => (
          <div key={index} className="my-5 flex flex-col flex-wrap">
      ...
      <div className="flex flex-col mb-5 flex-wrap">
      ...
      <section className="p-4 border-b border-gray-700 min-h-[20%] w-full">
