...
const Section_2 = () => {
  return (
    <div className="relative bg-blue-50 py-10 text-blue-900 sm:py-16 lg:py-24 lg:mb-32">
    <div>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <div className="mb-4 inline-flex h-12 w-12 text-[#4F46E5]">
          ...
          <h2 className="text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl text-[#4F46E5]">Start your journey with NAK Resume
            Builder.</h2>
          <p className="mt-4 text-xl font-medium text-[#4F46E5]">We offers you permium layout for resume.</p>

          <div className="sm mt-8 flex flex-col items-center justify-center sm:flex-row sm:space-x-4 sm:px-0 lg:mt-12">
            <button
              className="mt-4 rounded-lg border-2 border-blue-700 bg-[#4F46E5] px-6 py-2 font-medium text-white transition hover:translate-y-1">Try
              for free</button>
            <button
              className="mt-4 rounded-lg border-2 border-[#4F46E5] px-6 py-2 font-medium text-[#4F46E5] transition hover:translate-y-1">Choose
              a Plan</button>
          </div>
