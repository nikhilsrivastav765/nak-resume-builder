    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 px-6">
        {layouts.map((layout, index) => (
          <motion.div
            key={index}
            className="p-8 bg-gray-100 shadow-xl rounded-3xl flex flex-col items-center text-center border border-gray-300 lg:w-[500px] lg:h-[700px] transform transition-all duration-300 hover:scale-105"
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="mt-6 px-8 py-3 bg-blue-600 text-white font-semibold text-lg rounded-full shadow-lg hover:bg-blue-700 transition duration-300"
